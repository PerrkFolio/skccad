...
def get_p2p_kucoin(crypto):
    logger = init_logger("KuCoin", crypto)
    ...
    url = 'https://www.kucoin.com/ru/p2p-markets/rub/sell-' + crypto
        ...
        while True:
            try:
                if queue == 7:
                    ...
                    json_result = []
                    queue = 0
                url = 'https://www.kucoin.com/ru/p2p-markets/' + all_fiat[queue] + '/sell-' + crypto
                ...
                for item in fiat_list:
                    ...
                    payments = other.get_payments_kucoin(pay_methods, all_pay_methods)
...
if __name__ == '__main__':
    ...
    pool.map(get_p2p_kucoin, iterable)
